// Tech Stack Component with Authentic Technology Vector Logos

const ReactSvg = () => (
  <svg className="w-5 h-5 fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="1.6">
...
const FlutterSvg = () => (
  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
    <path d="M14.314 0L2.3 12 6.96 16.66 23.634 0h-9.32zm-4.654 14.332l-4.66 4.66 4.66 4.66h9.32l-4.66-4.66 4.66-4.66h-9.32z"/>
  </svg>
);
...
export default function Integrations() {
  const stack = [
    { name: 'React.js', desc: 'Frontend Web Apps', icon: ReactSvg },
    { name: 'TypeScript', desc: 'Type-Safe Software', icon: TypeScriptSvg },
    { name: 'Node.js', desc: 'Backend Microservices', icon: NodeJsSvg },
    { name: 'Next.js', desc: 'SEO & Server Rendering', icon: NextJsSvg },
    { name: 'PostgreSQL', desc: 'Enterprise Database', icon: PostgreSQLSvg },
    { name: 'Flutter', desc: 'Cross-Platform Mobile', icon: FlutterSvg },
    { name: 'AWS Cloud', desc: 'Cloud Infrastructure', icon: AwsSvg },
    { name: 'Docker', desc: 'Container Orchestration', icon: DockerSvg },
    { name: 'WordPress', desc: 'Custom CMS Platforms', icon: WordPressSvg },
    { name: 'Shopify', desc: 'E-Commerce Solutions', icon: ShopifySvg },
    { name: 'Python', desc: 'Data Analytics & AI', icon: PythonSvg },
    { name: 'GCP Cloud', desc: 'Global Edge Storage', icon: GcpSvg },
  ];
